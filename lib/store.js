...
export const voidTransactionItem = (...a) => store.voidTransactionItem(...a);
export const stocktake = (...a) => store.stocktake(...a);
export const exportAll = (...a) => store.exportAll(...a);
export const getKV = (...a) => store.getKV(...a);
export const setKV = (...a) => store.setKV(...a);
export const saveTxImage = (...a) => store.saveTxImage(...a);
export const getTxImage = (...a) => store.getTxImage(...a);
